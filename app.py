...
def get_aqi_level(pm25):
    """
    แปลงค่า PM2.5 เป็นระดับคุณภาพอากาศ, สี, และคำแนะนำ
    ตามมาตรฐานของประเทศไทย พร้อมคำแนะนำที่ปรับปรุงใหม่
    """
    # สีฟ้า: 0-15.0
    if pm25 <= 15:
        advice = """
    ...
    # สีส้ม: 37.6-75.0
        ...
        **กลุ่มเสี่ยง:** ควรงดการทำกิจกรรมกลางแจ้ง หากจำเป็นให้ใช้อุปกรณ์ป้องกันตนเองอย่างเข้มงวด
        """
        return "เริ่มมีผลกระทบต่อสุขภาพ", "#FF9900", "😷", advice
    # สีแดง: >75.0
    else: 
        advice = """
        ...
        **กลุ่มเสี่ยง:** ควรงดออกจากอาคารโดยเด็ดขาด และอยู่ในห้องปลอดฝุ่นหรืออาคารที่มีระบบฟอกอากาศ
        """
        return "มีผลกระทบต่อสุขภาพ", "#FF0000", "🤢", advice
